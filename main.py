...
from Prepare_metadata import load_metadata_from_raw_data, preprocess_metadata, save_metadata, load_metadata
...
if __name__ == '__main__':
    ...
    #print(preprocessed_metadata.head())
    # metadata can be saved for later usage/debugging issues
    #save_metadata(preprocessed_metadata,
     #             'C:/Users/AQ38570/Desktop/work/mcr_feature_extractor/opendev_metadata.xlsx')
    preprocessed_metadata = load_metadata('C:/Users/AQ38570/Desktop/work/mcr_feature_extractor/opendev_metadata.xlsx')
    print('starting crawling')
    project_features = ComputeStatistics(project_files_path=PROJECT_PATH,
                                         bots_accounts_ids=[], metadata=preprocessed_metadata,
                                         repos_path=PROJECT_REPOS_PATH,
                                         results_path='C:/Users/AQ38570/Desktop/work/mcr_feature_extractor')
    project_features.process_review_data()
    print('FIIIIIIIIIIIIIIIIIN')
